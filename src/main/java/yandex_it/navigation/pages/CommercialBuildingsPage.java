...
public class CommercialBuildingsPage extends AbstractRealtyPage {
    public CommercialBuildingsPage(WebDriver driver) {
        super(driver);
    }
    ...
    public boolean isCorrectPageOpened() {
        return DriverManager.getDriver().getCurrentUrl().endsWith("/kommercheskaya-nedvizhimost/");
    }
}
